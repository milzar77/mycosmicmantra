...
public class MantraDrawerGUI extends JFrame {
    ...
    public MantraDrawerGUI(String fileName, Vector<String> vMantraLines, Integer lmt, Long ik){
        super(fileName);
        CREATION_CODE = 1;
        LIMIT_KEYS = lmt;
        INTERVAL_KEYWORD = ik;
...
*/
    ...
    private static void calcolaSequenza(MantraDrawerGUI instance, boolean isFinalResize) {
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        Double x = screenSize.getWidth();
        Double y = screenSize.getHeight();
