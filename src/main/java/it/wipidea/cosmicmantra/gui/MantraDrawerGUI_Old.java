...
public class MantraDrawerGUI_Old extends JFrame {
    ...
    public MantraDrawerGUI_Old(String fileName, Vector<String> vMantraLines, Integer lmt, Long ik){
        super(fileName);
        CREATION_CODE = 1;
        LIMIT_KEYS = lmt;
        INTERVAL_KEYWORD = ik;
...
*/
    ...
    private static void scriviUltimaPosizione(Object[] objects) {
        File f = new File(MantraCoreRunner.GFX_PATH);
        try {
    ...
    private static void calcolaSequenza(MantraDrawerGUI_Old instance, boolean isFinalResize) {
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        Double x = screenSize.getWidth();
        Double y = screenSize.getHeight();
